...
export default function AdminLabResultDetailPage() {
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-rose-500 to-red-500 p-8 text-white text-center max-w-md">
          ...
          <div className="relative z-10">
            ...
            <Button
              ...
              onClick={() => router.push("/admin/lab-results")}
            >
              Quay lại
            </Button>
          </div>
  ...
  return (
    <div className="space-y-6">
      {/* Gradient Header - Admin uses teal/cyan theme */}
          ...
          <Card className="overflow-hidden border-0 shadow-lg">
            ...
            <CardContent className="p-4">
              ...
              {result.patientId && (
                ...
                >
                  <Link href={`/admin/patients/${result.patientId}`}>
                    Xem hồ sơ bệnh nhân
          ...
          <Card className="overflow-hidden border-0 shadow-lg">
            ...
            <CardContent className="p-4 space-y-3">
              ...
              {result.medicalExamId && (
                ...
                >
                  <Link href={`/admin/exams/${result.medicalExamId}`}>
                    Xem phiếu khám
                    <ExternalLink className="h-3 w-3 ml-2" />
                  </Link>
                </Button>
            ...
            <div className="space-y-2">
              ...
              <Select value={imageType} onValueChange={(v) => setImageType(v as ImageType)}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="PHOTO">Ảnh thường</SelectItem>
      ...
      <Dialog open={!!viewingImage} onOpenChange={() => setViewingImage(null)}>
        <DialogContent className="max-w-4xl">
          <DialogHeader>
            <DialogTitle>{viewingImage?.description || viewingImage?.fileName || "Hình ảnh"}</DialogTitle>
          </DialogHeader>
          {viewingImage && (
