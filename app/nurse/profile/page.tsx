...
export default function NurseProfilePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-pink-600 via-rose-500 to-red-500 p-6 text-white shadow-xl">
        ...
        <div className="relative">
          <div className="flex flex-wrap items-start justify-between gap-6">
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="relative group">
                <Avatar className="h-24 w-24 ring-4 ring-white/30 shadow-xl ring-offset-2 ring-offset-rose-500">
                  <AvatarImage src={employee.profileImageUrl || undefined} alt={employee.fullName} />
                  <AvatarFallback className="text-3xl font-bold text-white bg-gradient-to-br from-pink-400 to-rose-500">
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-4 mt-2 text-rose-100">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6 pt-6 border-t border-white/20">
            <div className="text-center">
              ...
              <div className="text-sm text-rose-200">Khoa</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold">{employee.licenseNumber || "—"}</div>
              <div className="text-sm text-rose-200">Số chứng chỉ</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold">{formatDate(employee.hiredAt)}</div>
              <div className="text-sm text-rose-200">Ngày vào làm</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold">{employee.status === "ACTIVE" ? "Có" : "Không"}</div>
              <div className="text-sm text-rose-200">Đang hoạt động</div>
            </div>
          </div>
        </div>
      </div>
          ...
          <Card className="border-2 border-slate-200 shadow-sm overflow-hidden">
            ...
            <CardContent className="pt-5">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <InfoRow icon={Briefcase} label="Vai trò" value="Điều dưỡng" />
                <InfoRow icon={Award} label="Số chứng chỉ hành nghề" value={employee.licenseNumber} />
                <InfoRow icon={Heart} label="Chuyên môn" value={employee.specialization} />
